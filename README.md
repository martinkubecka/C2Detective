...
- [x] integrate [C2Hunter](https://github.com/martinkubecka/C2Hunter) as a plugin for detection based on the processed threat feeds
  - [x] detect C2 IPs which received or initiated connections
  - [x] detect C2 domains which received or initiated connections

...
class DetectionEngine:
    ...
    def threat_feeds(self):
        ...
        if c2_detected:
            ...
            logging.info(
                f"Command & Control communication detected. (detected_ips : {detected_ips}) ; (detected_domains : {detected_domains})")
            ...
            print(
                f"[{time.strftime('%H:%M:%S')}] [INFO] {Fore.GREEN}Command & Control communication was not detected{Fore.RESET}")
